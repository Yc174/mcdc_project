...
def train(t_samples, t_targets):
    ...
    #
    try_different_method(reg, t_samples, t_targets, t_samples, t_targets)
    # x_train, x_test, y_train, y_test = train_test_split(t_samples, t_targets, test_size=0.1, random_state=42)
